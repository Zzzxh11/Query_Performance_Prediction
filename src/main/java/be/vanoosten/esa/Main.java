...
//         
//         Vectorizer vectorizer = new Vectorizer(termDocIndexDirectory, analyzer);
//         
//         SemanticSimilarityTool s = new SemanticSimilarityTool(vectorizer);
//         
//         float similarity = s.findSemanticSimilarity("Barack_Obama", "Barack_Obama");
    }
